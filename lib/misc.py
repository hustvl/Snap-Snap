...
def init_distributed_mode(distributed):
    if 'RANK' in os.environ and 'WORLD_SIZE' in os.environ and distributed:
...
def adjust_learning_rate(optimizer, epoch, args):
    ...
    if epoch < args.warmup_epochs:
        ...
        lr = args.min_lr + (args.lr - args.min_lr) * 0.5 * \
            (1. + math.cos(math.pi * (epoch - args.warmup_epochs) / (args.num_epoches - args.warmup_epochs)))
