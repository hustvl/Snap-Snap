...
def render_data(renderer, data_path, data_id, save_path, phase, cam_settings, res, dis=1.0, is_thuman=False):
    obj_path = os.path.join(data_path, phase, '%s.obj' % phase)
    texture_path = data_path
    img_path = os.path.join(data_path, phase, '%s.png' % phase)
...
if __name__ == '__main__':
    ...
    scene_radius = 2
    res = (1024, 1024)
    thuman_root = '/data/lujia/4D_dress'
    save_root = '/data/lujia/4D_dress_120_val'
...
# CUDA_VISIBLE_DEVICES=1 python prepare_data/render_data_2k2k.py